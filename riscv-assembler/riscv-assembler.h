...
public:
    ...
    std::array<r_pair, 5> rtype_inst_name = {
        r_pair{ "add", rtype_inst::r_add }, r_pair{ "sub", rtype_inst::r_sub },
        r_pair{ "xor", rtype_inst::r_xor }, r_pair{ "or", rtype_inst::r_or },
    ...
    std::array<i_pair, 4> itype_inst_name = {
        i_pair{ "addi", itype_inst::i_addi },
